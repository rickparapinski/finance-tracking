  ...
  return (
    <div className="w-64 border-r border-border bg-white shadow-[var(--shadow-soft)] text-slate-900 min-h-screen flex flex-col">
      ...
      <div className="p-4 border-t border-border mt-auto">
        <button className="flex items-center gap-3 px-3 py-2 w-full text-sm font-medium text-muted-foreground hover:text-foreground transition">
          <Settings size={18} />
          Settings
        </button>
      </div>
